...
let zkApp = new E2eZkApp(zkAppAddress);

let sentTx;
// compile the contract to create prover keys

const zkAppUri = 'https://e2e.xyz';
const tokenSymbol = 'E2E';

E2eZkApp.setZkAppUri(zkAppUri);
E2eZkApp.setTokenSymbol(tokenSymbol);

console.log('first compile...');
await E2eZkApp.compile({ forceRecompile: true });
